...
Abast:L’objectiu del projecte és simular la substitució d’un sistema de ràdio tradicional per un sistema basat en software defined radio (SDR) a l’institut, per entendre com aquesta tecnologia pot substituir el maquinari físic amb programar.
  ...
  Objectius específics:
    ...
    Entendre el funcionament de la tecnologia SDR.

    Dissenyar teòricament la instal·lació d’una antena SDR al centre.

    Identificar el material i el programari necessaris per al sistema.

    Comparar els avantatges del SDR respecte a la ràdio convencional.
